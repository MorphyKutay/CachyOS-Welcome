...
gpu-boosters-package-installed = GPU güçlendirici paketleri zaten kurulu!
...
install-gpu-boosters-title = GPU güçlendiricilerini kur
install-gpu-boosters-tooltip = AMD veya Intel GPU’larda dmemcg-booster ve plasma-foreground-booster paketlerini kur
